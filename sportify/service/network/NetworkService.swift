...
class NetworkService:NetworkServiceProtocol {
   ...
   private init() {
    ...
    func getLeagueUpcomingFixtures(sportName: String, leagueId: Int, completion: @escaping ([Upcoming]?) -> Void) {
        let url = "https://apiv2.allsportsapi.com/"+sportName+"/?met=Fixtures&APIkey=c0bddea4fa8a6125d9d6a00001e9ecd71e7107a99aeef4d1154c551d2feb96e8&from=\(DateFormat.getCurrentDate())&to=\(DateFormat.getDateToUpcommingTwoWeeksFromNow())&leagueId=\(leagueId)"
    ...
    func getLeagueLatestResults(sportName: String, leagueId: Int, completion: @escaping ([LatestResult]?) -> Void) {
        let url = "https://apiv2.allsportsapi.com/\(sportName)/?met=Fixtures&APIkey=c0bddea4fa8a6125d9d6a00001e9ecd71e7107a99aeef4d1154c551d2feb96e8&from=\(DateFormat.getDateToPreviousTwoWeeksFromNow())&to=\(DateFormat.getCurrentDate())&leagueId=\(leagueId)"
